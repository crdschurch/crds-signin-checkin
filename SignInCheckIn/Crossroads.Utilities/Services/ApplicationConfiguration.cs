...
namespace Crossroads.Utilities.Services
{
    public class ApplicationConfiguration : IApplicationConfiguration
    {
        ...
        public ApplicationConfiguration(IConfigurationWrapper configurationWrapper)
        {
            ...
            KcOneYearJan = configurationWrapper.GetConfigIntValue("May_1yr");
            KcOneYearJan = configurationWrapper.GetConfigIntValue("Jun_1yr");
            KcOneYearJan = configurationWrapper.GetConfigIntValue("Jul_1yr");
            KcOneYearAug = configurationWrapper.GetConfigIntValue("Aug_1yr");
            KcOneYearJan = configurationWrapper.GetConfigIntValue("Sep_1yr");
            KcOneYearJan = configurationWrapper.GetConfigIntValue("Oct_1yr");
            KcOneYearJan = configurationWrapper.GetConfigIntValue("Nov_1yr");
            KcOneYearJan = configurationWrapper.GetConfigIntValue("Dec_1yr");

            // two year olds
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("Jan_1yr");
            KcTwoYearFeb = configurationWrapper.GetConfigIntValue("Feb_1yr");
            KcTwoYearMar = configurationWrapper.GetConfigIntValue("Mar_1yr");
            KcTwoYearApr = configurationWrapper.GetConfigIntValue("Apr_1yr");
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("May_1yr");
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("Jun_1yr");
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("Jul_1yr");
            KcTwoYearAug = configurationWrapper.GetConfigIntValue("Aug_1yr");
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("Sep_1yr");
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("Oct_1yr");
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("Nov_1yr");
            KcTwoYearJan = configurationWrapper.GetConfigIntValue("Dec_1yr");

            // three year olds
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("Jan_1yr");
            KcThreeYearFeb = configurationWrapper.GetConfigIntValue("Feb_1yr");
            KcThreeYearMar = configurationWrapper.GetConfigIntValue("Mar_1yr");
            KcThreeYearApr = configurationWrapper.GetConfigIntValue("Apr_1yr");
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("May_1yr");
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("Jun_1yr");
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("Jul_1yr");
            KcThreeYearAug = configurationWrapper.GetConfigIntValue("Aug_1yr");
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("Sep_1yr");
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("Oct_1yr");
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("Nov_1yr");
            KcThreeYearJan = configurationWrapper.GetConfigIntValue("Dec_1yr");

            // four year olds
            KcFourYearJan = configurationWrapper.GetConfigIntValue("Jan_1yr");
            KcFourYearFeb = configurationWrapper.GetConfigIntValue("Feb_1yr");
            KcFourYearMar = configurationWrapper.GetConfigIntValue("Mar_1yr");
            KcFourYearApr = configurationWrapper.GetConfigIntValue("Apr_1yr");
            KcFourYearJan = configurationWrapper.GetConfigIntValue("May_1yr");
            KcFourYearJan = configurationWrapper.GetConfigIntValue("Jun_1yr");
            KcFourYearJan = configurationWrapper.GetConfigIntValue("Jul_1yr");
            KcFourYearAug = configurationWrapper.GetConfigIntValue("Aug_1yr");
            KcFourYearJan = configurationWrapper.GetConfigIntValue("Sep_1yr");
            KcFourYearJan = configurationWrapper.GetConfigIntValue("Oct_1yr");
            KcFourYearJan = configurationWrapper.GetConfigIntValue("Nov_1yr");
            KcFourYearJan = configurationWrapper.GetConfigIntValue("Dec_1yr");

            // five year olds
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("Jan_1yr");
            KcFiveYearFeb = configurationWrapper.GetConfigIntValue("Feb_1yr");
            KcFiveYearMar = configurationWrapper.GetConfigIntValue("Mar_1yr");
            KcFiveYearApr = configurationWrapper.GetConfigIntValue("Apr_1yr");
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("May_1yr");
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("Jun_1yr");
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("Jul_1yr");
            KcFiveYearAug = configurationWrapper.GetConfigIntValue("Aug_1yr");
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("Sep_1yr");
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("Oct_1yr");
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("Nov_1yr");
            KcFiveYearJan = configurationWrapper.GetConfigIntValue("Dec_1yr");
