...
namespace SignInCheckIn.Services
{
    public class ChildSigninService : IChildSigninService
    {
        ...
        public ParticipantEventMapDto SigninParticipants(ParticipantEventMapDto participantEventMapDto)
        {
            ...
            //_signInLogic.SignInParticipants()

            // We're basically creating two new event participant lists here, based on signing into each
            // event - this is now handled on a per-participant basis...

            //var mpAllEventParticipantDtoList = new List<MpEventParticipantDto>();


            // each of the two sign in sets is adding a range of participants to the mp event participant list - 
            // these participants are being generated by the set assigned room code
