...
namespace MinistryPlatform.Translation.Repositories
{
    public class EventRepository : IEventRepository
    {
        ...
        {
            return _ministryPlatformRestRepository.UsingAuthenticationToken(_apiUserRepository.GetDefaultApiUserToken())
        ...
        {
            return
                _ministryPlatformRestRepository.UsingAuthenticationToken(_apiUserRepository.GetDefaultApiUserToken())
        ...
        public List<MpCapacityDto> GetCapacitiesForEvent(int eventId)
        {
            ...
            var result = _ministryPlatformRestRepository.UsingAuthenticationToken(_apiUserRepository.GetDefaultApiUserToken()).GetFromStoredProc<MpCapacityDto>("api_crds_Capacity_App_Data", parms);
            return result[0];
        }
    }
}
