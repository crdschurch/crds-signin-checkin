...
describe('NewFamilyRegistrationComponent', () => {
  it('#ngOnInit', () => {
    ...
    let fixture = new NewFamilyRegistrationComponent(route, apiService, headerService, adminService, rootService, router);
    fixture.ngOnInit();
    expect(apiService.getEvent).toHaveBeenCalledWith(event.EventId);
    expect(adminService.getGradeGroups).toHaveBeenCalledWith();
